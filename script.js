document.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('click', (event) => {
    ...
    if (offScreenMenu && gemMenuToggle && offScreenMenu.classList.contains('active') && !offScreenMenu.contains(event.target) && !gemMenuToggle.contains(event.target)) {
        ...
        document.body.classList.remove('menu-open'); // Remove body class when menu closes
        document.documentElement.classList.remove('menu-open'); // Remove from html element too
    }
  });
  ...
  if (gemMenuToggle && offScreenMenu) {
    gemMenuToggle.addEventListener('click', (e) => {
      ...
      document.body.classList.toggle('menu-open'); // Toggle body class for pushing content
      document.documentElement.classList.toggle('menu-open'); // Toggle html class for hiding scrollbar
    });
  }
  ...
  const aiCharacter = document.getElementById('aiCharacter'); // Get the AI character element
  ...
  if (stickyAssistant) {
    stickyAssistant.addEventListener('click', () => {
      ...
      aiCharacter.classList.add('thinking'); // Add 'thinking' class for a different animation
      ...
      setTimeout(() => {
        ...
        aiCharacter.classList.remove('thinking'); // Remove 'thinking' class
  ...
  if (aiSuggestOK) {
    ...
    // If the modal is closed by OK, ensure the AI character returns to idle state
    if (aiCharacter) {
  ...
  const reviewAbstract = document.getElementById('abstract'); // Corrected ID to 'abstract' from 'reviewAbstract'
